    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('status', 'select', array(
            ...
            'values' => array(
                ...
                array('value' => 3, 'label' => Mage::helper('affiliateplus')->__('Denied'))
            ),
            'disabled' => $disabled,
        ...
        $fieldset->addField('approved_at', 'text', array(
            'label' => Mage::helper('affiliateplus')->__('Approved Date'),
            'name' => 'approved_at',
            'readonly'  => 'readonly',
        ));
        ...
        // added by Tab (18/11/2016)
        $fieldset->addField('description', 'editor', array(
            'label' => Mage::helper('affiliateplus')->__('Description'),
            'name' => 'description',
